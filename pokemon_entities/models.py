...
class Pokemon(models.Model):
    ...
    title_en = models.CharField(max_length=200, blank=True, verbose_name="Покемон(english)")
    title_jp = models.CharField(max_length=200, blank=True, verbose_name="Покемон(japan)")
...
class PokemonEntity(models.Model):
    ...
    pokemon = models.ForeignKey(
        Pokemon, null=True, on_delete=models.CASCADE, verbose_name="Покемон"
    )
    lat = models.FloatField(null=True, verbose_name="Широта")
    lon = models.FloatField(null=True, verbose_name="Долгота")
    appeared_at = models.DateTimeField(null=True, verbose_name="Появиться")
